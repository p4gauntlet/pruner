...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            local_decls=[
ValueDeclaration("oHvtbH", P4Initializer(z3.BoolVal(False), z3.BoolSort()), z3_type=z3.BoolSort()), 
...
ValueDeclaration("NdjDFo", P4Initializer(z3.BoolVal(True), z3.BoolSort()), z3_type=z3.BoolSort()), 
...
P4Declaration("CBiEr", P4Action("CBiEr", params=[
                    ...
                    AssignmentStatement("SYsGZI", z3.BitVecVal(340282366920938463463374607431768211446, 128)),
...
P4Declaration("YSvMfd", P4Table("YSvMfd", key=[(z3.BitVecVal(0, 128), "exact"), ], actions=[], default_action=MethodCallExpr("NoAction", [], ), immutable=False)), ]
        ))
    )
    z3_reg.declare_global(
