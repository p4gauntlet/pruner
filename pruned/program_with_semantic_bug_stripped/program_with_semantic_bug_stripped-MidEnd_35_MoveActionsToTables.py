...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member("tbl_program_with_semantic_bug_stripped241", "apply"), [], )),]
            ),
            local_decls=[
P4Declaration("program_with_semantic_bug_stripped241", P4Action("program_with_semantic_bug_stripped241", params=[],                 body=BlockStatement([
...
P4Declaration("tbl_program_with_semantic_bug_stripped241", P4Table("tbl_program_with_semantic_bug_stripped241", actions=[MethodCallExpr("program_with_semantic_bug_stripped241", [], ), ], default_action=MethodCallExpr("program_with_semantic_bug_stripped241", [], ), immutable=True)), ]
        ))
    )
    z3_reg.declare_global(
