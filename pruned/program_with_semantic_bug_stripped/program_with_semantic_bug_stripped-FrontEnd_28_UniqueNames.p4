...
bit<32> ZqTDGWH() {
    {
        @name("sGPTcR") bit<64> sGPTcR_0 = 64w10;
        {
            sGPTcR_0 = sGPTcR_0;
            @name("LRpMbf") bit<32> LRpMbf_0 = 32w10;
            sGPTcR_0 = 64w152762851772443914;
            return LRpMbf_0;
        }
        sGPTcR_0 = sGPTcR_0;
        @name("noVnDj") bit<64> noVnDj_0 = 64w10;
        noVnDj_0 = 64w10;
...
Vnytmj IBaXWsK(bit<64> yQJV, bit<16> gOEI) {
    @name("kXmlrB") bit<8> kXmlrB_0 = 8w10;
    {
        kXmlrB_0 = kXmlrB_0;
        kXmlrB_0 = kXmlrB_0;
        ZqTDGWH();
...
control PFizfTj(out bit<16> lcNR, bit<128> SZxu) {
    @name("xQNzSP") bit<32> xQNzSP_0 = 32w10;
    @name("SYsGZI") bit<128> SYsGZI_0 = 128w10;
    apply {
        xQNzSP_0 = 32w0;
        ZqTDGWH();
        SYsGZI_0 = SYsGZI_0;
