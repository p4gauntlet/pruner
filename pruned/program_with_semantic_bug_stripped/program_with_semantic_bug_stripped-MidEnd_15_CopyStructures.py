        ...
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    ...
                    BlockStatement([
                        AssignmentStatement(P4Member("retval", "PZdb"), z3.BoolVal(False)),
                        AssignmentStatement(P4Member("retval", "xjKr"), z3.BitVecVal(3697682998, 32)),
                        AssignmentStatement(P4Member("retval", "pBFG"), z3.BitVecVal(14442, 16)),
                        AssignmentStatement(P4Member("retval", "VYDJ"), z3.BoolVal(False)),
                        AssignmentStatement(P4Member("retval", "GXQs"), z3.BitVecVal(127537729978999984111170865926198740152, 128)),]
                    ),]
                ),
                ...
                BlockStatement([
                    ...
                    BlockStatement([
                        AssignmentStatement(P4Member("retval_6", "PZdb"), z3.BoolVal(False)),
                        AssignmentStatement(P4Member("retval_6", "xjKr"), z3.BitVecVal(10, 32)),
                        AssignmentStatement(P4Member("retval_6", "pBFG"), z3.BitVecVal(14442, 16)),
                        AssignmentStatement(P4Member("retval_6", "VYDJ"), z3.BoolVal(False)),
                        AssignmentStatement(P4Member("retval_6", "GXQs"), z3.BitVecVal(127537729978999984111170865926198740152, 128)),]
                    ),]
                ),
                BlockStatement([
                    ...
                    BlockStatement([
                        AssignmentStatement(P4Member("retval_8", "PZdb"), z3.BoolVal(False)),
                        AssignmentStatement(P4Member("retval_8", "xjKr"), z3.BitVecVal(10, 32)),
                        AssignmentStatement(P4Member("retval_8", "pBFG"), z3.BitVecVal(14442, 16)),
                        AssignmentStatement(P4Member("retval_8", "VYDJ"), z3.BoolVal(False)),
                        AssignmentStatement(P4Member("retval_8", "GXQs"), z3.BitVecVal(127537729978999984111170865926198740152, 128)),]
                    ),]
                ),
