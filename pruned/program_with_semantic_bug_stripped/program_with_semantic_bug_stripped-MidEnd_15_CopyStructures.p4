    ...
    apply {
        {
            ...
            {
                retval.PZdb = false;
                retval.xjKr = 32w3697682998;
                retval.pBFG = 16w14442;
                retval.VYDJ = false;
                retval.GXQs = 128w127537729978999984111170865926198740152;
            }
        }
        ...
        }
        {
            ...
            hasReturned_4 = true;
            {
                retval_6.PZdb = false;
                retval_6.xjKr = 32w10;
                retval_6.pBFG = 16w14442;
                retval_6.VYDJ = false;
                retval_6.GXQs = 128w127537729978999984111170865926198740152;
            }
        }
        {
            hasReturned_6 = false;
            ...
            hasReturned_6 = true;
            {
                retval_8.PZdb = false;
                retval_8.xjKr = 32w10;
                retval_8.pBFG = 16w14442;
                retval_8.VYDJ = false;
                retval_8.GXQs = 128w127537729978999984111170865926198740152;
            }
        }
