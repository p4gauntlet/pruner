    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Parser(
            ...
            body=ParserTree([
                ...
                ParserState(name="noMatch", select="reject",
                components=[
                MethodCallStmt(MethodCallExpr("verify", [], z3.BoolVal(False), P4Member("error", "NoMatch"), )),                ]),
                ])
))
    )
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    ...
                    AssignmentStatement("retval", P4Cast(P4Initializer([z3.BoolVal(False), z3.BitVecVal(3697682998, 32), z3.BitVecVal(14442, 16), z3.BoolVal(False), z3.BitVecVal(127537729978999984111170865926198740152, 128), ], ), "Vnytmj")),]
                ),
                ...
                BlockStatement([
                    ...
                    AssignmentStatement("retval_6", P4Cast(P4Initializer([z3.BoolVal(False), z3.BitVecVal(10, 32), z3.BitVecVal(14442, 16), z3.BoolVal(False), z3.BitVecVal(127537729978999984111170865926198740152, 128), ], ), "Vnytmj")),]
                ),
                BlockStatement([
                    ...
                    AssignmentStatement("retval_8", P4Cast(P4Initializer([z3.BoolVal(False), z3.BitVecVal(10, 32), z3.BitVecVal(14442, 16), z3.BoolVal(False), z3.BitVecVal(127537729978999984111170865926198740152, 128), ], ), "Vnytmj")),]
                ),
