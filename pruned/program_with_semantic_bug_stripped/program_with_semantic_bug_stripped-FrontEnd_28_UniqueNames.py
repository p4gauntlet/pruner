...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        P4Declaration("ZqTDGWH", P4Function("ZqTDGWH", return_type=z3.BitVecSort(32), params=[],         body=BlockStatement([
            BlockStatement([
                ValueDeclaration("sGPTcR_0", P4Initializer(z3.BitVecVal(10, 64), z3.BitVecSort(64)), z3_type=z3.BitVecSort(64)),
                BlockStatement([
                    AssignmentStatement("sGPTcR_0", "sGPTcR_0"),
                    ValueDeclaration("LRpMbf_0", P4Initializer(z3.BitVecVal(10, 32), z3.BitVecSort(32)), z3_type=z3.BitVecSort(32)),
                    AssignmentStatement("sGPTcR_0", z3.BitVecVal(152762851772443914, 64)),
                    P4Return("LRpMbf_0"),]
                ),
                AssignmentStatement("sGPTcR_0", "sGPTcR_0"),
                ValueDeclaration("noVnDj_0", P4Initializer(z3.BitVecVal(10, 64), z3.BitVecSort(64)), z3_type=z3.BitVecSort(64)),
                AssignmentStatement("noVnDj_0", z3.BitVecVal(10, 64)),
                AssignmentStatement("noVnDj_0", z3.BitVecVal(859692371, 64)),
                AssignmentStatement("sGPTcR_0", z3.BitVecVal(0, 64)),
                AssignmentStatement("sGPTcR_0", P4add(z3.BitVecVal(10240, 64), "noVnDj_0")),
            ...
            AssignmentStatement("AfXLZG_0", z3.BitVecVal(10, 128)),
    ...
    z3_reg.declare_global(
        P4Declaration("IBaXWsK", P4Function("IBaXWsK", return_type="Vnytmj", params=[
            ...
            ValueDeclaration("kXmlrB_0", P4Initializer(z3.BitVecVal(10, 8), z3.BitVecSort(8)), z3_type=z3.BitVecSort(8)),
            BlockStatement([
    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            local_decls=[
ValueDeclaration("xQNzSP_0", P4Initializer(z3.BitVecVal(10, 32), z3.BitVecSort(32)), z3_type=z3.BitVecSort(32)), 
ValueDeclaration("SYsGZI_0", P4Initializer(z3.BitVecVal(10, 128), z3.BitVecSort(128)), z3_type=z3.BitVecSort(128)), ]
        ))
    )
    z3_reg.declare_global(
