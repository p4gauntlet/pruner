        ...
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    ...
                    ValueDeclaration("retval_1", None, z3_type="Vnytmj"),
                    ...
                    BlockStatement([
                        ...
                        ValueDeclaration("retval_2", None, z3_type=z3.BitVecSort(32)),
                        ValueDeclaration("sGPTcR", None, z3_type=z3.BitVecSort(64)),
                        ValueDeclaration("LRpMbf", None, z3_type=z3.BitVecSort(32)),
                        AssignmentStatement("sGPTcR", z3.BitVecVal(10, 64)),
                        AssignmentStatement("LRpMbf", z3.BitVecVal(10, 32)),
                        AssignmentStatement("hasReturned_2", z3.BoolVal(True)),
                        AssignmentStatement("retval_2", "LRpMbf"),]
                    ),
                    AssignmentStatement("hasReturned_1", z3.BoolVal(True)),
                    AssignmentStatement("retval_1", P4Cast(P4Initializer([z3.BoolVal(False), P4Cast(z3.BitVecVal(11378255015260334646, 64), z3.BitVecSort(32)), z3.BitVecVal(14442, 16), z3.BoolVal(False), z3.BitVecVal(127537729978999984111170865926198740152, 128), ], ), "Vnytmj")),]
                ),
                AssignmentStatement("IArlRL_SYsGZI_0", z3.BitVecVal(10, 128)),
                AssignmentStatement("IArlRL_xQNzSP_0", z3.BitVecVal(0, 32)),
                BlockStatement([
                    ValueDeclaration("hasReturned_2", P4Initializer(z3.BoolVal(False), z3.BoolSort()), z3_type=z3.BoolSort()),
                    ValueDeclaration("retval_2", None, z3_type=z3.BitVecSort(32)),
                    ValueDeclaration("sGPTcR", None, z3_type=z3.BitVecSort(64)),
                ...
                BlockStatement([
                    ...
                    AssignmentStatement("hasReturned_1", z3.BoolVal(True)),
                    AssignmentStatement("retval_3", P4Cast(P4Initializer([z3.BoolVal(False), P4Cast(z3.BitVecVal(10, 64), z3.BitVecSort(32)), z3.BitVecVal(14442, 16), z3.BoolVal(False), z3.BitVecVal(127537729978999984111170865926198740152, 128), ], ), "Vnytmj")),]
                ),
                BlockStatement([
                    ValueDeclaration("hasReturned_1", P4Initializer(z3.BoolVal(False), z3.BoolSort()), z3_type=z3.BoolSort()),
                    ...
                    AssignmentStatement("hasReturned_1", z3.BoolVal(True)),
                    AssignmentStatement("retval_4", P4Cast(P4Initializer([z3.BoolVal(False), P4Cast(z3.BitVecVal(10, 64), z3.BitVecSort(32)), z3.BitVecVal(14442, 16), z3.BoolVal(False), z3.BitVecVal(127537729978999984111170865926198740152, 128), ], ), "Vnytmj")),]
                ),
