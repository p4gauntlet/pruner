...
control ingress(inout Headers h) {
    ...
    apply {
        {
            @name("hasReturned_0") bool hasReturned = false;
            @name("retval_0") Vnytmj retval;
        ...
        {
            @name("hasReturned_0") bool hasReturned_4 = false;
            @name("retval_0") Vnytmj retval_6;
        ...
        {
            @name("hasReturned_0") bool hasReturned_6 = false;
            @name("retval_0") Vnytmj retval_8;
        ...
        {
            @name("hasReturned") bool hasReturned_8 = false;
            @name("retval") bit<32> retval_10;
