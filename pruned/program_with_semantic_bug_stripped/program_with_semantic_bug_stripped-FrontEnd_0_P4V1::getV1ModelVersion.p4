...
Vnytmj IBaXWsK(bit<64> yQJV, bit<16> gOEI) {
    bit<8> kXmlrB = 8w10;
    {
        ...
        ZqTDGWH();
        kXmlrB = 8w174;
        return (Vnytmj){PZdb = false,xjKr = (bit<32>)yQJV,pBFG = 16w14442,VYDJ = !!(9w10 != 9w10 && !!!!(51w10 == 51w10)),GXQs = 128w127537729978999984111170865926198740152};
    }
...
control PFizfTj(out bit<16> lcNR, bit<128> SZxu) {
    bool oHvtbH = !(!(57w10 == 57w10) || true);
    bit<64> nYJwrn = 64w10;
    bool htHGwZ = !!oHvtbH;
    bit<32> xQNzSP = 32w10;
    bit<128> SYsGZI = (bit<128>)128w10;
    bool NdjDFo = 113w10[62:9] != 54w10 || true;
    ...
    table YSvMfd {
        key = {
            213w10[157:30]: exact @name("iZjain") ;
        }
        actions = {
            @defaultonly NoAction();
        }
...
control ingress(inout Headers h) {
    ...
    apply {
        h.zkbz.WNfX = (16w10 | 16w58652) + 16w10;
