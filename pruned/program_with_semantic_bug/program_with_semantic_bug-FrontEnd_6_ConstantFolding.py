...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        P4Declaration("ZqTDGWH", P4Function("ZqTDGWH", return_type=z3.BitVecSort(32), params=[],         body=BlockStatement([
            ...
            P4Return(P4Cast(P4bor(839498710, P4Cast("AfXLZG", z3.BitVecSort(32))), z3.BitVecSort(32))),]
        )        )        )
    )
    z3_reg.declare_global(
        P4Declaration("IBaXWsK", P4Function("IBaXWsK", return_type="Vnytmj", params=[
            ...
            BlockStatement([
                ...
                P4Return([z3.BoolVal(False), P4Cast("yQJV", z3.BitVecSort(32)), z3.BitVecVal(14442, 16), P4not(P4not(P4land(P4ne(P4bor(P4Cast(MethodCallExpr("ZqTDGWH", [], ), z3.BitVecSort(9)), z3.BitVecVal(260, 9)), P4Cast(MethodCallExpr("ZqTDGWH", [], ), z3.BitVecSort(9))), P4not(P4not(P4not(P4not(P4eq(z3.BitVecVal(1444364813109517, 51), P4Cast("gOEI", z3.BitVecSort(51)))))))))), z3.BitVecVal(127537729978999984111170865926198740152, 128), ]),]
            ),
...
ValueDeclaration("SYsGZI", P4Initializer(18672238, z3.BitVecSort(128)), z3_type=z3.BitVecSort(128)), 
...
P4Declaration("woqMg", P4Action("woqMg", params=[
                    ...
                    BlockStatement([
                        ...
                        AssignmentStatement("nYJwrn", 440494971),
                        ...
                        AssignmentStatement("lcNR", P4neg(925022518)),
