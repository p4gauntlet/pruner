...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        P4Declaration("ZqTDGWH", P4Function("ZqTDGWH", return_type=z3.BitVecSort(32), params=[],         body=BlockStatement([
            ...
            ValueDeclaration("noVnDj_0", None, z3_type=z3.BitVecSort(64)),
            ...
            BlockStatement([
                ...
                AssignmentStatement("sGPTcR_0", "sGPTcR_0"),
                AssignmentStatement("noVnDj_0", z3.BitVecVal(1172448623121743915, 64)),
            ...
            AssignmentStatement("AfXLZG_0", z3.BitVecVal(2144402680, 128)),
