...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    IfStatement(P4not(P4ne(P4bor(P4Cast(P4subsat(z3.BitVecVal(37657, 32), P4Cast(z3.BitVecVal(8331771506825847071, 64), z3.BitVecSort(32))), z3.BitVecSort(9)), z3.BitVecVal(260, 9)), P4Cast(P4subsat(z3.BitVecVal(37657, 32), P4Cast(z3.BitVecVal(8331771506825847071, 64), z3.BitVecSort(32))), z3.BitVecSort(9)))), BlockStatement([
