...
bit<32> ZqTDGWH() {
    ...
    return (bit<32>)(839498710 | (bit<32>)AfXLZG);
}
Vnytmj IBaXWsK(bit<64> yQJV, bit<16> gOEI) {
    bit<8> kXmlrB = (((bit<43>)yQJV | (bit<43>)yQJV) |+| 43w1462566353592)[16:9];
    {
        ...
        ZqTDGWH();
        kXmlrB = 8w174;
        return { false, (bit<32>)yQJV, 16w14442, !!((bit<9>)ZqTDGWH() | 9w260 != (bit<9>)ZqTDGWH() && !!!!(51w1444364813109517 == (bit<51>)gOEI)), 128w127537729978999984111170865926198740152 };
    }
