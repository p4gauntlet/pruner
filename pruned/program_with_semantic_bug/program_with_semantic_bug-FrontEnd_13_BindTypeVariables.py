        ...
        P4Declaration("ZqTDGWH", P4Function("ZqTDGWH", return_type=z3.BitVecSort(32), params=[],         body=BlockStatement([
            BlockStatement([
                ...
                BlockStatement([
                    ...
                    ValueDeclaration("LRpMbf", P4Initializer(P4Cast(P4subsat(z3.BitVecVal(37657, 32), P4Cast("sGPTcR", z3.BitVecSort(32))), z3.BitVecSort(32)), z3.BitVecSort(32)), z3_type=z3.BitVecSort(32)),
                ...
                AssignmentStatement("sGPTcR", P4add(P4lshift(P4sub("sGPTcR", z3.BitVecVal(11817574793371717234, 64)), z3.BitVecVal(55, 8)), "noVnDj")),
            ...
            P4Return(P4Cast(P4bor(z3.BitVecVal(839498710, 32), P4Cast("AfXLZG", z3.BitVecSort(32))), z3.BitVecSort(32))),]
        )        )        )
    )
    z3_reg.declare_global(
        P4Declaration("IBaXWsK", P4Function("IBaXWsK", return_type="Vnytmj", params=[
            ...
            ValueDeclaration("kXmlrB", P4Initializer(P4Slice(P4addsat(P4bor(P4Cast("yQJV", z3.BitVecSort(43)), P4Cast("yQJV", z3.BitVecSort(43))), z3.BitVecVal(1462566353592, 43)), 16, 9), z3.BitVecSort(8)), z3_type=z3.BitVecSort(8)),
            BlockStatement([
                BlockStatement([
            ...
            AssignmentStatement("kXmlrB", "kXmlrB"),
            MethodCallStmt(MethodCallExpr("ZqTDGWH", [], )),
            P4Return(P4Cast(P4Initializer([z3.BoolVal(True), z3.BitVecVal(1354969928, 32), "gOEI", z3.BoolVal(True), P4band(P4Cast(P4Member("wUxkGX", "iUNX"), z3.BitVecSort(128)), P4Cast(P4Member("wUxkGX", "PamX"), z3.BitVecSort(128))), ], ), "Vnytmj")),]
        )        )        )
    )
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            local_decls=[
ValueDeclaration("oHvtbH", P4Initializer(P4not(P4lor(P4not(P4eq(P4bor(P4subsat(P4Slice(P4Cast(P4Cast("SZxu", z3.BitVecSort(79)), z3.BitVecSort(79)), 78, 22), z3.BitVecVal(128961855891103457, 57)), z3.BitVecVal(83480883236889332, 57)), P4Cast("lcNR", z3.BitVecSort(57)))), z3.BoolVal(True))), z3.BoolSort()), z3_type=z3.BoolSort()), 
...
ValueDeclaration("SYsGZI", P4Initializer(P4Cast(z3.BitVecVal(18672238, 128), z3.BitVecSort(128)), z3.BitVecSort(128)), z3_type=z3.BitVecSort(128)), 
ValueDeclaration("NdjDFo", P4Initializer(P4lor(P4ne(P4Slice(P4addsat(P4Cast(P4Cast("nYJwrn", z3.BitVecSort(113)), z3.BitVecSort(113)), P4Cast("lcNR", z3.BitVecSort(113))), 62, 9), z3.BitVecVal(2143205456929516, 54)), z3.BoolVal(True)), z3.BoolSort()), z3_type=z3.BoolSort()), 
P4Declaration("woqMg", P4Action("woqMg", params=[
                    ...
                    BlockStatement([
                        ...
                        AssignmentStatement("nYJwrn", P4Cast(z3.BitVecVal(440494971, 64), z3.BitVecSort(64))),
                        ...
                        AssignmentStatement("lcNR", P4Cast(z3.BitVecVal(18122, 16), z3.BitVecSort(16))),
