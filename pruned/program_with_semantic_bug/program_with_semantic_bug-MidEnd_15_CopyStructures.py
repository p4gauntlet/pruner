        ...
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                BlockStatement([
                    ...
                    AssignmentStatement("kXmlrB_0", z3.BitVecVal(210, 8)),
                    ...
                    AssignmentStatement("tmp_5", z3.BitVecVal(3697682998, 32)),
                    ...
                    BlockStatement([
                        AssignmentStatement(P4Member("retval_0", "PZdb"), "tmp_4"),
                        AssignmentStatement(P4Member("retval_0", "xjKr"), "tmp_5"),
                        AssignmentStatement(P4Member("retval_0", "pBFG"), "tmp_6"),
                        AssignmentStatement(P4Member("retval_0", "VYDJ"), "tmp_7"),
                        AssignmentStatement(P4Member("retval_0", "GXQs"), "tmp_18"),]
                    ),]
                ),
                ...
                BlockStatement([
                    ...
                    AssignmentStatement("kXmlrB_1", z3.BitVecVal(255, 8)),
                    ...
                    AssignmentStatement("tmp_32", z3.BitVecVal(2897353309, 32)),
                    ...
                    BlockStatement([
                        AssignmentStatement(P4Member("retval_10", "PZdb"), "tmp_31"),
                        AssignmentStatement(P4Member("retval_10", "xjKr"), "tmp_32"),
                        AssignmentStatement(P4Member("retval_10", "pBFG"), "tmp_33"),
                        AssignmentStatement(P4Member("retval_10", "VYDJ"), "tmp_34"),
                        AssignmentStatement(P4Member("retval_10", "GXQs"), "tmp_41"),]
                    ),]
                ),
                BlockStatement([
                    AssignmentStatement("hasReturned_12", z3.BoolVal(False)),
                    AssignmentStatement("kXmlrB_2", z3.BitVecVal(255, 8)),
                    ...
                    AssignmentStatement("tmp_43", z3.BitVecVal(117282381, 32)),
                    ...
                    BlockStatement([
                        AssignmentStatement(P4Member("retval_14", "PZdb"), "tmp_42"),
                        AssignmentStatement(P4Member("retval_14", "xjKr"), "tmp_43"),
                        AssignmentStatement(P4Member("retval_14", "pBFG"), "tmp_44"),
                        AssignmentStatement(P4Member("retval_14", "VYDJ"), "tmp_45"),
                        AssignmentStatement(P4Member("retval_14", "GXQs"), "tmp_52"),]
                    ),]
                ),
