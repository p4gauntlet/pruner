...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        P4Declaration("ZqTDGWH", P4Function("ZqTDGWH", return_type=z3.BitVecSort(32), params=[],         body=BlockStatement([
            BlockStatement([
                ValueDeclaration("sGPTcR_0", P4Initializer(z3.BitVecVal(8331771506825847071, 64), z3.BitVecSort(64)), z3_type=z3.BitVecSort(64)),
                BlockStatement([
                    AssignmentStatement("sGPTcR_0", "sGPTcR_0"),
                    ValueDeclaration("LRpMbf_0", P4Initializer(P4subsat(z3.BitVecVal(37657, 32), P4Cast("sGPTcR_0", z3.BitVecSort(32))), z3.BitVecSort(32)), z3_type=z3.BitVecSort(32)),
                    AssignmentStatement("sGPTcR_0", z3.BitVecVal(152762851772443914, 64)),
                    P4Return("LRpMbf_0"),]
                ),
                AssignmentStatement("sGPTcR_0", "sGPTcR_0"),
                ValueDeclaration("noVnDj_0", P4Initializer(z3.BitVecVal(1172448623121743915, 64), z3.BitVecSort(64)), z3_type=z3.BitVecSort(64)),
                AssignmentStatement("noVnDj_0", z3.BitVecVal(9155524997714835150, 64)),
                AssignmentStatement("noVnDj_0", z3.BitVecVal(859692371, 64)),
                AssignmentStatement("sGPTcR_0", z3.BitVecVal(0, 64)),
                AssignmentStatement("sGPTcR_0", P4add(P4lshift(P4add("sGPTcR_0", z3.BitVecVal(6629169280337834382, 64)), z3.BitVecVal(55, 8)), "noVnDj_0")),
                P4Return(z3.BitVecVal(2806012093, 32)),]
            ),
            ValueDeclaration("AfXLZG_0", P4Initializer(z3.BitVecVal(2144402680, 128), z3.BitVecSort(128)), z3_type=z3.BitVecSort(128)),
            AssignmentStatement("AfXLZG_0", z3.BitVecVal(23939084785281499464369578139775539458, 128)),
            AssignmentStatement("AfXLZG_0", "AfXLZG_0"),
            AssignmentStatement("AfXLZG_0", "AfXLZG_0"),
            AssignmentStatement("AfXLZG_0", z3.BitVecVal(306288353508935945900133283398710167980, 128)),
            AssignmentStatement("AfXLZG_0", "AfXLZG_0"),
            BlockStatement([
                AssignmentStatement("AfXLZG_0", z3.BitVecVal(203190633050105623488232349361061266317, 128)),
                AssignmentStatement("AfXLZG_0", z3.BitVecVal(119851796932508784808775619006417521460, 128)),
                AssignmentStatement("AfXLZG_0", z3.BitVecVal(89063546262527641425054991023365647631, 128)),
                AssignmentStatement("AfXLZG_0", "AfXLZG_0"),
                AssignmentStatement("AfXLZG_0", z3.BitVecVal(8310206894313765100920948761954001695, 128)),
                AssignmentStatement("AfXLZG_0", z3.BitVecVal(232550981149043971176658599253778146419, 128)),
                AssignmentStatement("AfXLZG_0", "AfXLZG_0"),
    ...
    z3_reg.declare_global(
        P4Declaration("IBaXWsK", P4Function("IBaXWsK", return_type="Vnytmj", params=[
            ...
            ValueDeclaration("kXmlrB_0", P4Initializer(P4Slice(P4addsat(P4Cast("yQJV", z3.BitVecSort(43)), z3.BitVecVal(1462566353592, 43)), 16, 9), z3.BitVecSort(8)), z3_type=z3.BitVecSort(8)),
            BlockStatement([
                AssignmentStatement("kXmlrB_0", "kXmlrB_0"),
                AssignmentStatement("kXmlrB_0", "kXmlrB_0"),
                MethodCallStmt(MethodCallExpr("ZqTDGWH", [], )),
                AssignmentStatement("kXmlrB_0", z3.BitVecVal(174, 8)),
            ...
            AssignmentStatement("kXmlrB_0", z3.BitVecVal(14, 8)),
            AssignmentStatement("kXmlrB_0", "kXmlrB_0"),
            MethodCallStmt(MethodCallExpr("ZqTDGWH", [], )),
    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                AssignmentStatement("xQNzSP_0", P4subsat(P4add("xQNzSP_0", MethodCallExpr("ZqTDGWH", [], )), z3.BitVecVal(2827375294, 32))),
                MethodCallStmt(MethodCallExpr("ZqTDGWH", [], )),
                AssignmentStatement("SYsGZI_0", "SYsGZI_0"),
                AssignmentStatement("xQNzSP_0", "xQNzSP_0"),
                MethodCallStmt(MethodCallExpr("IBaXWsK", [], z3.BitVecVal(9569382937354443357, 64), z3.BitVecVal(0, 16), )),
                AssignmentStatement("SYsGZI_0", P4bor(P4add("SYsGZI_0", z3.BitVecVal(165438478943825846563807071914571104592, 128)), "SZxu")),]
            ),
            local_decls=[
ValueDeclaration("xQNzSP_0", P4Initializer(z3.BitVecVal(1305108261, 32), z3.BitVecSort(32)), z3_type=z3.BitVecSort(32)), 
ValueDeclaration("SYsGZI_0", P4Initializer(z3.BitVecVal(18672238, 128), z3.BitVecSort(128)), z3_type=z3.BitVecSort(128)), ]
        ))
    )
    z3_reg.declare_global(
