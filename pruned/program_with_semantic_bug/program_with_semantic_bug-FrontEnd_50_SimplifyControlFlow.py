        ...
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                BlockStatement([
                    ...
                    AssignmentStatement("tmp_15", "retval"),]
                ),
                ...
                BlockStatement([
                    ...
                    AssignmentStatement("tmp_0", P4Cast(z3.BitVecVal(11378255015260334646, 64), z3.BitVecSort(32))),
                    ...
                    BlockStatement([
                        ...
                        AssignmentStatement("hasReturned", z3.BoolVal(True)),
                        AssignmentStatement("retval", "LRpMbf_0"),
                        AssignmentStatement("tmp_4", "retval"),]
                    ),
                    ...
                    BlockStatement([
                        ...
                        AssignmentStatement("hasReturned", z3.BoolVal(True)),
                        AssignmentStatement("retval", "LRpMbf_0"),
                        AssignmentStatement("tmp_6", "retval"),]
                    ),
                    ...
                    IfStatement(P4not("tmp_7"), BlockStatement([
                        ...
                        AssignmentStatement("tmp_8", P4eq(z3.BitVecVal(1444364813109517, 51), P4Cast(z3.BitVecVal(59162, 16), z3.BitVecSort(51)))),]
                    )),
                    ...
                    AssignmentStatement("retval_0", P4Cast(P4Initializer(["tmp", "tmp_0", "tmp_1", "tmp_2", "tmp_9", ], ), "Vnytmj")),]
                ),
                ...
                BlockStatement([
                    ...
                    AssignmentStatement("hasReturned", z3.BoolVal(True)),
                    AssignmentStatement("retval", "LRpMbf_0"),
                    AssignmentStatement("IArlRL_tmp_0", "retval"),]
                ),
                ...
                BlockStatement([
                    ...
                    ValueDeclaration("tmp_9", None, z3_type=z3.BitVecSort(128)),
                    ValueDeclaration("kXmlrB_0", None, z3_type=z3.BitVecSort(8)),
                    AssignmentStatement("kXmlrB_0", P4Slice(P4addsat(P4Cast(z3.BitVecVal(9569382937354443357, 64), z3.BitVecSort(43)), z3.BitVecVal(1462566353592, 43)), 16, 9)),
                    AssignmentStatement("kXmlrB_0", "kXmlrB_0"),
                    BlockStatement([
                        ValueDeclaration("hasReturned", P4Initializer(z3.BoolVal(False), z3.BoolSort()), z3_type=z3.BoolSort()),
                        ValueDeclaration("retval", None, z3_type=z3.BitVecSort(32)),
                    ...
                    AssignmentStatement("tmp", z3.BoolVal(False)),
                    AssignmentStatement("tmp_0", P4Cast(z3.BitVecVal(9569382937354443357, 64), z3.BitVecSort(32))),
                    AssignmentStatement("tmp_1", z3.BitVecVal(14442, 16)),
                    BlockStatement([
                        ValueDeclaration("hasReturned", P4Initializer(z3.BoolVal(False), z3.BoolSort()), z3_type=z3.BoolSort()),
                        ValueDeclaration("retval", None, z3_type=z3.BitVecSort(32)),
                    ...
                    IfStatement(P4not("tmp_7"), BlockStatement([
                        ...
                        AssignmentStatement("tmp_8", P4eq(z3.BitVecVal(1444364813109517, 51), P4Cast(z3.BitVecVal(0, 16), z3.BitVecSort(51)))),]
                    )),
                    AssignmentStatement("tmp_2", "tmp_8"),
                    AssignmentStatement("tmp_9", z3.BitVecVal(127537729978999984111170865926198740152, 128)),
                    AssignmentStatement("hasReturned_0", z3.BoolVal(True)),
                ...
                BlockStatement([
                    ...
                    ValueDeclaration("tmp_9", None, z3_type=z3.BitVecSort(128)),
                    ValueDeclaration("kXmlrB_0", None, z3_type=z3.BitVecSort(8)),
                    AssignmentStatement("kXmlrB_0", P4Slice(P4addsat(P4Cast(z3.BitVecVal(16257984866694305357, 64), z3.BitVecSort(43)), z3.BitVecVal(1462566353592, 43)), 16, 9)),
                    AssignmentStatement("kXmlrB_0", "kXmlrB_0"),
                    BlockStatement([
                        ValueDeclaration("hasReturned", P4Initializer(z3.BoolVal(False), z3.BoolSort()), z3_type=z3.BoolSort()),
                        ValueDeclaration("retval", None, z3_type=z3.BitVecSort(32)),
                    ...
                    AssignmentStatement("tmp", z3.BoolVal(False)),
                    AssignmentStatement("tmp_0", P4Cast(z3.BitVecVal(16257984866694305357, 64), z3.BitVecSort(32))),
                    AssignmentStatement("tmp_1", z3.BitVecVal(14442, 16)),
                    BlockStatement([
                        ValueDeclaration("hasReturned", P4Initializer(z3.BoolVal(False), z3.BoolSort()), z3_type=z3.BoolSort()),
                        ValueDeclaration("retval", None, z3_type=z3.BitVecSort(32)),
                    ...
                    IfStatement(P4not("tmp_7"), BlockStatement([
                        ...
                        AssignmentStatement("tmp_8", P4eq(z3.BitVecVal(1444364813109517, 51), P4Cast(z3.BitVecVal(65535, 16), z3.BitVecSort(51)))),]
                    )),
                    AssignmentStatement("tmp_2", "tmp_8"),
                    AssignmentStatement("tmp_9", z3.BitVecVal(127537729978999984111170865926198740152, 128)),
                    AssignmentStatement("hasReturned_0", z3.BoolVal(True)),
