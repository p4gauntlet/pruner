...
def p4_program(z3_reg):
    ...
    z3_reg.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member("tbl_program_with_semantic_bug116", "apply"), [], )),]
            ),
            local_decls=[
...
P4Declaration("program_with_semantic_bug116", P4Action("program_with_semantic_bug116", params=[],                 body=BlockStatement([
...
P4Declaration("tbl_program_with_semantic_bug116", P4Table("tbl_program_with_semantic_bug116", actions=[MethodCallExpr("program_with_semantic_bug116", [], ), ], default_action=MethodCallExpr("program_with_semantic_bug116", [], ), immutable=True)), ]
        ))
    )
    z3_reg.declare_global(
