...
bit<32> ZqTDGWH() {
    {
        @name("sGPTcR") bit<64> sGPTcR_0 = 64w8331771506825847071;
        {
            sGPTcR_0 = sGPTcR_0;
            @name("LRpMbf") bit<32> LRpMbf_0 = 32w37657 |-| (bit<32>)sGPTcR_0;
            sGPTcR_0 = 64w152762851772443914;
            return LRpMbf_0;
        }
        sGPTcR_0 = sGPTcR_0;
        @name("noVnDj") bit<64> noVnDj_0 = 64w1172448623121743915;
    ...
    @name("AfXLZG") bit<128> AfXLZG_0 = 128w2144402680;
...
Vnytmj IBaXWsK(bit<64> yQJV, bit<16> gOEI) {
    @name("kXmlrB") bit<8> kXmlrB_0 = ((bit<43>)yQJV |+| 43w1462566353592)[16:9];
    {
        kXmlrB_0 = kXmlrB_0;
        kXmlrB_0 = kXmlrB_0;
        ZqTDGWH();
